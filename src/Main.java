public class Main {
    public static void main(String[] args) {
        ...
        compareStud.compareStudentsGriffindor(2,1);
        compareStud.compareStudentsSlytherin(1, 2);
        compareStud.compareStudentsHufflepuff(1, 2);
        compareStud.compareStudentsRavenclaw(1, 2);
        compareStud.comparedGeneralSkills(10, 9);
